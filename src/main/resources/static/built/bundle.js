...
/***/ (function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
	    ...
	    _createClass(App, [{
	        ...
	        key: 'loadImagesFromServer',
	        value: function loadImagesFromServer() {
	            var _this2 = this;
	
	            fetch('http://localhost:8090/app/images', { credentials: 'same-origin' }).then(function (response) {
	        ...
	        value: function addImage(image) {
	            ...
	            fetch('http://localhost:8090/app/images/image{id}', { method: 'POST',
	                ...
	                return _this3.loadImagesFromServer();
	            }).catch(function (err) {
	        ...
	        value: function getImage(image) {
	            ...
	            fetch('http://localhost:8090/app/images/image{id}', { method: 'GET',
	                credentials: 'same-origin',
	                headers: {
	                    'Content-Type': 'application/json'
	                },
	                ...
	                return _this4.loadImagesFromServer();
	            }).catch(function (err) {
	                return console.error(err);
	            });
	        }
	        ...
	        value: function updateImage(image) {
	            ...
	            fetch(image.link, { method: 'PUT',
	                ...
	                return _this5.loadImagesFromServer();
	            }).catch(function (err) {
	                return console.error(err);
	            });
	        }
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(ImageTable, { images: this.state.images,
	                    updateImage: this.updateImage }),
	                _react2.default.createElement(ImageForm, { addImage: this.addImage }),
	                _react2.default.createElement(Alert, { stack: true, timeout: 2000 })
	            );
	        }
	    }]);
	...
	var ImageTable = function (_React$Component2) {
	    _inherits(ImageTable, _React$Component2);
	
	    function ImageTable(props) {
	        _classCallCheck(this, ImageTable);
	
	        return _possibleConstructorReturn(this, (ImageTable.__proto__ || Object.getPrototypeOf(ImageTable)).call(this, props));
	    }
	
	    _createClass(ImageTable, [{
	        key: 'render',
	        value: function render() {
	            var _this7 = this;
	
	            var images = this.props.images.map(function (image) {
	                return _react2.default.createElement(Image, { key: image._links.self.href, image: image, updateImage: _this7.props.updateImage });
	            });
	...
	var Images = function (_React$Component3) {
	    ...
	    function Images(props) {
	        ...
	        var _this8 = _possibleConstructorReturn(this, (Images.__proto__ || Object.getPrototypeOf(Images)).call(this, props));
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'td',
	                    null,
	                    _react2.default.createElement(StudentUpdateForm, { updateImage: this.props.updateImage, image: this.props.image })
	                )
	            );
	        }
	    }]);
	...
	var ImageForm = function (_React$Component4) {
	    _inherits(ImageForm, _React$Component4);
	
	    function ImageForm(props) {
	        _classCallCheck(this, ImageForm);
	
	        var _this9 = _possibleConstructorReturn(this, (ImageForm.__proto__ || Object.getPrototypeOf(ImageForm)).call(this, props));
	
	        _this9.state = { id: '', name: '', location: '' };
	    ...
	    _createClass(ImageForm, [{
	        ...
	        value: function handleSubmit(event) {
	            ...
	            var newImage = { id: this.state.id, name: this.state.name, location: this.state.location };
